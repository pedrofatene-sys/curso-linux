...
const channels = [
    { id: 'R_8l3xj3QEg', name: 'Onde o Linux pode ser usado?' },
    { id: 'qs_NZXmVUr0', name: 'De onde veio o Linux? O que é software livre?' },
    ...
    { id: 'kK6eBHSxAgA', name: 'Terminal no Linux - Manipulando diretórios' },
    { id: '7XQ3Qt7EuWg', name: 'Terminal Linux - Referência Global' },
    { id: 'GEU0tmpjVfM', name: 'Manipulação de Arquivos com Linux' },
    { id: 'Ntg1JfjEAd4', name: 'Uso de pendrives e HDs externos no Linux' }    
];
